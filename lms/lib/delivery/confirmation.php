    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="text-center">
                    ...
                    <hr>
                    <h4 class="text-light bg-success text-center p-2 rounded-3 mb-0">LKR <?= number_format($value, 2) ?>
                    </h4>
                </div>
            </div>
            <div class="col-md-8 mt-4 mt-md-0">
                <form id="submit-form" method="post">
                    ...
                    <input type="hidden" name="payment_method" id="payment_method"
                        value="<?= $paymentMethods[0]['id'] ?>" required>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="fullName" id="fullName"
                                placeholder="Eg: Thilina Ruwan" required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="streetAddress" id="streetAddress"
                                placeholder="Eg: 533A3, Hospital Road" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="city" id="city" placeholder="Eg: Pelmadulla"
                                required>
                        </div>
                        <div class="col-12 col-md-6 mb-3">
                            <label for="fullName" class="text-secondary">District</label>
                            <input type="text" class="form-control" name="district" id="district"
                                placeholder="Eg: Rathnapura District" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="phoneNumber1" id="phoneNumber1"
                                placeholder="Eg: 0770481000" required>
                        </div>
                        <div class="col-12 col-md-6  mb-3">
        ...
        <div class="row mt-3">
            <div class="col-12 rounded-3 bg-light p-3 text-end">
                ...
                <button type="button" class="btn btn-light" onclick="ClosePopUP()"><i class="fa-solid fa-xmark"></i>
                    Close</button>
                <button type="button" class="btn btn-dark" onclick="PlaceOrder()"><i
                        class="fa-solid fa-cart-shopping"></i> Place Order</button>
            </div>
        </div>
