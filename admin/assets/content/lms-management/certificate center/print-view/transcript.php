...
if (empty($imageBase64)) {
    echo "Error generating base64 string.";
} else {
...
<div class="main-content">
    ...
    <div class="content">
        <h3 class="document-topic">Academic Transcript</h3>
        ...
        <p>This is to clarify that <span class="text-normal"><?= capitalizeWordsWithSpaceAfterFullStop($UserInfo['name_on_certificate']) ?></span> has successfully
            completed the <span class="text-normal"><?= $Course['course_name'] ?></span> offered by Ceylon Pharma College during the academic year <?= $AcademicYear ?>.</p>
        ...
        <table class="details-table">
            ...
            <tr>
                ...
                <td>:</td>
                <td class="data-value"><?= date('d/m/Y', strtotime($PrintDate)) ?></td>
            </tr>
            <tr>
                <td class="detail-title">Duration</td>
                <td>:</td>
                <td class="data-value"><?= $duration ?></td>
            </tr>
        </table>
        ...
        <div class="sp-note">Note: This certification was issued by Ceylon Pharma College on <span class="text-bold"><?= date('d/m/Y', strtotime($ConvocationDate)) ?>,</span> at the <span class="text-bold"><?= $ConvocationPlace ?>.</span></div>
