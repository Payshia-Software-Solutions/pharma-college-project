	...
	<div class="page-wraper">
		...
		<div class="page-content bg-white">
			...
			<div class="content-block">
				...
				<!-- Top Students Start -->
				<?php include './component/top-students.php'; ?>
				<!-- Top Students End -->

				<!-- Mini About -->
				<?php include './component/mini-about.php'; ?>
				<!-- Mini About END -->

				<!-- Upcoming Events -->
				<?php include './component/upcoming-events.php'; ?>
				<!-- Upcoming Events END -->
