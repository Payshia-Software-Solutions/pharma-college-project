        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-4 offset-4">
                    ...
                    <select class="form-control" name="studentBatch" id="studentBatch" onchange="GetOrderSummary(this.value, document.getElementById('orderType').value)">
                ...
                <div class="col-4">
                    ...
                    <select class="form-control" name="orderType" id="orderType" onchange="GetOrderSummary(document.getElementById('studentBatch').value, this.value)">
                        <option value="0">All</option>
                        <?php
                        if (!empty($Deliveries)) {
