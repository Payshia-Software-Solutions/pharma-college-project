...
function OpenIndex() {
  function fetch_data() {
    ...
    $.ajax({
      url: "./assets/content/lms-management/update-payment/index.php",
      method: "POST",
      data: {
...
function OpenPayment(txnNumber) {
  ...
  function fetch_data() {
    $.ajax({
      url: "assets/content/lms-management/update-payment/payment-modal.php",
      method: "POST",
      data: {
        LoggedUser: LoggedUser,
        UserLevel: UserLevel,
