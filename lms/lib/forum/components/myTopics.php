        ...
        <div class="card-body p-4">
            ...
            <div class="row g-2">
                ...
                <div class="col-12">
                    ...
                    <a href="./community-post?id=<?= $selectArray['id'] ?>&title=<?= $selectArray['title'] ?>#response"
                        style="text-decoration: none;">
                        <button class="btn btn-light rounded-3"><i class="fa-solid fa-comment text-secondary"></i> Add
                            Response</button>
                    </a>
                    <button class="btn btn-light rounded-3"><i class="fa-solid fa-comment text-secondary"></i>
                        Replies</button>
                    <button class="btn btn-light rounded-3"><i class="fa-solid fa-eye text-secondary"></i>
                        Views</button>
                    <button class="btn btn-light rounded-3" type="button"><i class="fa-solid fa-check"></i> Mark as
                        Solved</button>
                </div>
            </div>
        </div>
