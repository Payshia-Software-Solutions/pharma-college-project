...
<div class="row g-3">
    <div class="col-md-8">
        <h5 class="table-title">Accounts Operations</h5>
        <div class="row g-3">
            <?php
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="row g-2">
                                            ...
                                            <div class="col-12 text-end">
                                                <button type="button" onclick=" OpenBatchStudents('<?= $selectedCourseCode ?>')" class="btn btn-dark btn-sm"><i class="fa-solid fa-eye"></i> View Detail</button>
                                            </div>
                                        </div>
                                    </div>
