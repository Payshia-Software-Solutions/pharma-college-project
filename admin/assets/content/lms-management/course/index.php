                        ...
                        <div class="card flex-fill">
                            <div class="card-body p-2 pb-2">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-9">
                                        Pharma Hunter Pro Report
                                    </div>
                                    <div class="col-3">
                                        <button class="mt-0 mb-1 btn btn-sm btn-light view-button w-100" type="button" onclick="PrintGameReport ('pharma-hunter-pro-report', '<?= $studentBatch ?>', 'all', '<?= $defaultLocation ?>')"><i class="fa-solid fa-print"></i></button>
                                    </div>
                                    ...
                                    <div class="col-3">
                                        <button class="mt-0 mb-1 btn btn-sm btn-light view-button w-100" type="button" onclick="PrintGameReport ('course-assignment-report', '<?= $studentBatch ?>', 'all', '<?= $defaultLocation ?>')"><i class="fa-solid fa-print"></i></button>
                                    </div>
