<form action="#" id="ticket-form" method="post" enctype="multipart/form-data">
    <div class="row g-2">
        ...
        <div class="col-12">
            ...
            <p class="mb-0 text-secondary">Please give the information about the problem occur!</p>
        ...
        <div class="col-md-3">
            <label for="department">Related Service</label>
        ...
        <div class="col-12">
            <label for="ticketText">Ticket Description</label>
            <textarea class="form-control" rows="4" name="ticketText" id="ticketText"></textarea>
        </div>

        <div class="col-12">
            <label for="imageUploads">Select Attachments</label>
            <input class="form-control" type="file" name="files[]" id="files" multiple>

        </div>

        <div class="col-12 text-end mt-3">
            <button type="button" class="btn btn-dark" onclick="SaveTicket()">Open Ticket</button>
        </div>
    </div>
</form>
