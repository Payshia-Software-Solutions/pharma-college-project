...
$defaultTemplateId = $CompleteDate = $convocationDate = $convocationPlace = $transcriptBackImage = $duration = '';
if (isset($certificateDefaults[$selectedCourse])) {
    ...
    $duration = $certificateDefaults[$selectedCourse]['duration'];
}
?>
                ...
                <form action="#" id="config-form">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" type="text" name="duration" id="duration" value="<?= $duration ?>" required>
                        </div>
