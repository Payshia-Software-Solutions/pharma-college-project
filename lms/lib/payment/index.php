            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12 text-end">
                        <button type="button" class="btn btn-dark"><i class="fa-solid fa-credit-card"></i> Pay Now</button>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                <div class="row g-2">
                                    <div class="col-6 col-12">
                                        ...
                                        <h5 class="mb-0 border-bottom pb-2"><?= $batchList[$selectedArray['course_code']]['course_name'] ?></h5>
                                    </div>
                                    <div class="col-12 col-lg-4 text-center text-md-start d-flex">
                                        <div class="card bg-light border-0 flex-fill">
                                            <div class="card-body">
                                                ...
                                                <h5 class="fw-bold mb-0"><?= number_format($courseFee, 2) ?> + <?= number_format($registration_fee, 2) ?> </h5>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-3 text-center text-md-start d-flex">
                                        <div class="card bg-light border-0 flex-fill">
                                            <div class="card-body">
                                                ...
                                                <h2 class="fw-bold mb-0 due-balance"><?= number_format($courseDueAmount, 2) ?></h2>
                                            </div>
                                        </div>
                                    </div>
