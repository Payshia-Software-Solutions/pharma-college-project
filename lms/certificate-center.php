...
<head>
    ...
    <link rel="stylesheet" href="./lib/certificate-center/assets/css/styles-1.0.css">
</head>
...
<body>
    ...
    <!-- Custom Scripts -->
    <script src="./lib/certificate-center/assets/js/scripts-1.0.0.js"></script>
