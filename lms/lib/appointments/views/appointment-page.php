...
<div class="row mb-3">
    <div class="col-12 text-end">
        <button class="btn btn-warning" onclick="GetStared()">Reload</button>
    </div>
</div>

<div class="row g-3">
    <div class="col-12">
        <button class="btn btn-primary w-100 rounded-3">Add New Appointment</button>
    </div>

    <div class="col-12 col-md-6 col-lg-4">
        <div class="card border-0 shadow">
            <div class="card-body">
                <h3>Appointment 003</h3>
            </div>
        </div>
    </div>
</div>