...
function generateRandomAddress()
{
    $streets = [
        ...
        'Blossom Street',
        'Enchanted Gardens Boulevard',
        'Fairway Lane',
        'Cobblestone Street',
        'Crystal Clear Avenue',
        'Silver Maple Lane',
        'Royal Gardens Drive',
        'Thunderbird Lane',
        'Eagle Crest Boulevard',
        'Gentle Breeze Street',
        'Harbor View Drive',
        'Prairie Lane',
        'Dreamy Hollow Avenue',
        'Cascade Street',
        'Mystic Meadow Lane',
        'Silverado Avenue',
        'Amber Street',
        'Quail Ridge Lane',
        'Eternal Bliss Boulevard'
    ];
