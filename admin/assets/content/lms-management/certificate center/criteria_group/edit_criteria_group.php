...
<div class="loading-popup-content" id="content-container">
    ...
    <h3 class="border-bottom pb-2">Edit Criteria Group</h3>

    <form method="POST" action="update_criteria_group.php" id="UpdateCriteriaGroupForm">
        ...
        <div class="mb-3">
            <h6 class="selected_criteria-lable">Selecte Criterias</h6>
        ...
        <div class="text-end">
            <button type="button" class="btn btn-light" onclick="OpenEditCriteriaGroup('<?= $LoggedUser ?>', <?= $criteriaGroupId ?>)">Clear</button>
            <button type="submit" class="btn btn-dark" id="UpdateButton" onclick="updateCriteriaGroupInfo()">Save</button>
        </div>
    </form>
</div>