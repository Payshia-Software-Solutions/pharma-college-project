...
function PrintCertificate(studentNumber, selectedCourse) {
  ...
  if (form.checkValidity()) {
    ...
    var url =
      "assets/content/lms-management/certification/print-view/certificate.php?" +
      "studentNumber=" +
...
function PrintTranscript(studentNumber, selectedCourse) {
  ...
  if (form.checkValidity()) {
    ...
    var url =
      "assets/content/lms-management/certification/print-view/transcript.php?" +
      "studentNumber=" +
      encodeURIComponent(studentNumber) +
      "&selectedCourse=" +
      encodeURIComponent(selectedCourse) +
...
function PrintWorkshop(studentNumber, selectedCourse) {
  ...
  if (form.checkValidity()) {
    ...
    var url =
      "assets/content/lms-management/certification/print-view/workshop-certificate.php?" +
      "studentNumber=" +
      encodeURIComponent(studentNumber) +
      "&selectedCourse=" +
      encodeURIComponent(selectedCourse) +
