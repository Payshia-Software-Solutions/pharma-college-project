    ...
    <div class="card rounded-4 shadow border-0">
        <div class="card-body p-4">
            ...
            <div class="row g-2">
                ...
                <div class="col-md-3">
                    <div class="badge rounded-5"
                        style="background-color: <?= $CategoriesList[$selectArray['category']]['bg_color'] ?>">
                        <?= $CategoriesList[$selectArray['category']]['category_name'] ?></div>
                    <span class="badge bg-<?= $solveStatusBgColor ?> rounded-5"><?= $solveStatus ?></span>
                </div>

                <div class="col-12">
                    <a href="./community-post?id=<?= $selectArray['id'] ?>&title=<?= $selectArray['title'] ?>"
                ...
                <div class="col-12">
                    <a class="text-dark"
                        href="./community-post?id=<?= $selectArray['id'] ?>&title=<?= $selectArray['title'] ?>"
                        style="text-decoration: none;">
                ...
                <div class="col-12 d-flex gap-2 flex-wrap justify-content-between">
                    <button class="btn btn-light rounded-3 flex-fill"><i class="fa-solid fa-comment text-secondary"></i>
                        <?= count($replyList) ?> Replies</button>
                    <button class="btn btn-light rounded-3 flex-fill"><i class="fa-solid fa-eye text-secondary"></i>
                        <?= $selectArray['views'] ?> Views</button>

                    <button class="btn btn-light rounded-3 flex-fill"><i
                            class="fa-solid fa-bookmark text-secondary"></i></button>
                    <a class="btn btn-light rounded-3 flex-fill"
                        href="./community-post?id=<?= $selectArray['id'] ?>&title=<?= $selectArray['title'] ?>#response"
                        style="text-decoration: none;">
